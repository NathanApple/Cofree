...
public class BarcodeScanner extends Application {
    ...
    public List<Rectangle2D> detectFaces(Mat mat) {
        //
        // e = grabFrame();
        // TextResult[] results = reader.decodeBuffer(matToByteArray(frame),
        // frame.width(), frame.height(),
        // (int) frame.step1(), EnumImagePixelFormat.IPF_BGR_888, "");
    ...
    static void main(String[] args) {
        ...
        // System.loadLibrary("C:\\opencv\\build\\bin");
